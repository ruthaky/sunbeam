...
export default function Abasection() {
  return (
    <div
      className="relative w-full h-auto py-[70px] lg:pt-[100px] lg:pb-[100px] flex flex-col gap-6 lg:gap-8 px-6 lg:px-[200px] bg-[#D4F9FF] lg:bg-opacity-0 justify-center bg-cover"
